...
// 결과 확인
console.log(korea);
console.log(korea.countryName); // "Korea"
console.log(korea.idolGroups[0].GroupName); // "IVE"
console.log(korea.idolGroups[0].members[0].idolName); // "안유진"
console.log(korea.idolGroups[0].members[0].dance()); // "안유진이 춤을 춥니다."
console.log(korea.idolGroups[1].GroupName); // "BTS"
console.log(korea.idolGroups[1].members[0].idolName); // "진"
console.log(korea.idolGroups[1].members[0].sing()); // "진이 노래를 합니다."
